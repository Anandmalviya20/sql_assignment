...
set sql_safe_updates=0; 
  ...
  /*Q.3) STATEMENT TO CREATE CONTACT EMPLOYEE TABLE */
...
/* Q. 11) What do you understand about DDL, DCL, and DML in MySQL?
   ANS --> DDL    = Data defination language is concerned with database and description of how data sshould be stored in the database. 
           DDL    = create database , drop database, create table, alter table , drop table , create index, create view etc. 
            
		   DML    = Data manipulation language deals with data manipulation and include the most common sql statement such as SELECT , INSERT, UPDATE ,
                         DELETE, REPLACE etc. 
		   
           DCL   = DATA CONTROL LANGUAGE include command such as GRANT AND REVOKE . IT is also auto comitted .*/
